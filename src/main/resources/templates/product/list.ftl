                            ...
                            <tr>
                                ...
                                <td>
                                    <#if productInfo.productStatus == 0>
                                        <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}" onClick="return confirm('确定下架?');">下架</a>
                                    <#else >
                                        <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}" onClick="return confirm('确定上架?');">上架</a>
                                    </#if>
                                </td>
                            </tr>
                            </#list>
